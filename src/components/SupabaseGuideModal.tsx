...
-- Notifications Table (Syncs with Android App & Web Candidates in Realtime)
CREATE TABLE IF NOT EXISTS notifications (
  id TEXT PRIMARY KEY,
  title TEXT NOT NULL,
  message TEXT NOT NULL,
  type TEXT DEFAULT 'NEW_JOB_POSTED',
  "targetRole" TEXT DEFAULT 'CANDIDATE',
  "recipientId" TEXT DEFAULT 'ALL',
  "jobId" TEXT,
  "applicationId" TEXT,
  "recruiterId" TEXT,
  "candidateId" TEXT,
...
-- 4. ENABLE SUPABASE REALTIME REPLICATION FOR ANDROID & WEB CLIENTS
